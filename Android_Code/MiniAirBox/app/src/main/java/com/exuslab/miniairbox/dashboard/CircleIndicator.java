...
package com.exuslab.miniairbox.dashboard;
...
import com.exuslab.miniairbox.R;
...
public class CircleIndicator extends BaseCircle {
    ...
    private void drawCircleContent(Canvas canvas, IndicatorItem item, RectF oval,
                                   float perAngle, float textRadius, Path path,
                                   Paint textPaint, Paint circlePaint) {
